...
# best_ckpt = os.path.join("checkpoints", file, "checkpoint-28000")
...
c1 = f'CUDA_VISIBLE_DEVICES={gpu} python eval_bestout_rank_loss.py {common} --model_path {best_ckpt} --result_path results/{model_name}'
