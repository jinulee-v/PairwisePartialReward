...
from model.model_ppr import PPRParaphraser
from model.metrics import *
from model.perplexity import Perplexity

logger = logging.getLogger(__name__)

class PPRTrainer(Seq2SeqTrainer):
...
def main():
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, Seq2SeqTrainingArguments, PPRArguments, EvaluationArguments))
